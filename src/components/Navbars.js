        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
         <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              {/* <Link className="nav-link active" aria-current="page" to="/">{props.listItem1}</Link> */}
              <a className="nav-link active" aria-current="page" href="/">{props.listItem1}</a>
            </li>
            {/* <li className="nav-item">
              <Link className="nav-link" to="/about">{props.listItem2}</Link>
            </li> */}
...
//   listItem1: "Set ListItem1 Here",
//   listItem2: "Set ListItem2 Here"
// };